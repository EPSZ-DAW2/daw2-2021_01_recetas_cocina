...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-01-2022 a las 00:31:43
...
(1, 'Chorizo', 'El chorizo es un embutido cárnico originario de la península ibérica, ​ tradicional también en la cocina latinoamericana y de otras regiones con influencia cultural española y portuguesa, en donde puede formar parte de la cocina fusión.', 'pesado'),
(2, 'Morcilla', 'La morcilla es un embutido a base de sangre cocida, generalmente de cerdo, de color caoba oscuro. Suele mezclarse con grasa de cerdo, y además, contiene algún otro ingrediente no cárnico para aumentar su volumen, como arroz u otros cereales, miga de pan o cebolla.', 'pesado'),
(3, 'Alubia de la granja', 'Se denomina judiones de la Granja a una variedad de judía de gran tamaño que se cultiva en Real Sitio de San Ildefonso, la Phaseolus coccineus, también denominada Phaseolus multiflorus Willd., que se cree que fue traída de América y plantada en La Granja a comienzos del siglo XVIII.', 'normal'),
(4, 'Panceta', 'La panceta o tocineta es un producto cárnico que comprende la piel y las capas que se encuentran bajo la piel del cerdo o puerco, específicamente de los músculos ventrales. Está compuesta de la piel y tocino entreverado de carne magra.', 'pesado'),
(5, 'Pimentón', 'El pimentón o ají de color es un condimento en polvo de color rojo-anaranjado y sabor característico obtenido a partir del secado y molido de determinadas variedades de pimientos rojos especialmente la ñora y la páprika.', 'normal'),
(6, 'Agua', 'Agua potable o agua apta para el consumo humano se denomina al agua que puede ser consumida sin restricción para beber o preparar alimentos.​​', 'ligero'),
(7, 'Sal', 'La sal común o sal de mesa, conocida popularmente como sal, es un tipo de sal denominada cloruro sódico, cuya fórmula química es NaCl.', 'normal'),
(8, 'Filete de ternera', 'Se llama carne de ternera a la carne de los bovinos que se han criado por lo menos seis meses de edad hasta el momento del sacrificio. Estas reses pesan 135 kg de promedio. La industria cárnica es la encargada de procesar los subproductos de la carne de ternera.', 'normal'),
(9, 'Jamón serrano', 'El jamón serrano es un alimento obtenido a partir de la salazón y secado al aire de las patas traseras del cerdo. Este mismo producto recibe también el nombre de paleta o paletilla cuando se obtiene de las patas delanteras. El jamón serrano se contrapone al jamón cocido, también llamado jamón de York o \"jamón dulce\".', 'normal'),
(10, 'Aceite de oliva', 'El aceite de oliva es un aceite vegetal de uso principalmente culinario. Se obtiene del fruto del olivo, denominado oliva o aceituna.​ Casi la tercera parte de la pulpa de la aceituna es aceite. Por esta razón, desde la Antigüedad se ha extraído fácilmente con una simple presión ejercida por un molino.', 'normal'),
(11, 'Queso de cabra', 'El queso de cabra, también llamado chèvre es cualquier queso hecho con leche de cabra.', 'pesado'),
(12, 'Pan rallado', 'El pan rallado o pan molido es pan duro, generalmente seco de varios días, que ha sido finamente picado mediante un rallador. Su textura harinosa se emplea en la elaboración de diferentes platos y alimentos en forma de rebozado, empanado o gratinado con la intención de proporcionar una costra dura al freírlos.', 'normal'),
(13, 'Huevo', 'Los huevos de las aves constituyen un alimento habitual en la alimentación de los humanos. Se presentan protegidos por una cáscara y son ricos en proteínas y lípidos.​​', 'normal'),
(14, 'Ajo', 'Allium sativum, el ajo, es una especie tradicionalmente clasificada dentro de la familia de las liliáceas pero que actualmente se ubica en la de las amarilidáceas, ​ aunque este extremo es muy discutido.', 'ligero'),
(15, 'Pimiento del piquillo', 'El pimiento del piquillo o pimiento de piquillo​ es una variedad de pimiento producido en Lodosa en la Comunidad Foral de Navarra.', 'ligero'),
(16, 'Patatas', 'Solanum tuberosum, de nombre común papa​ o patata, ​ es una especie herbácea perteneciente al género Solanum de la familia de las solanáceas, originaria de la región que comprende el altiplano sur del Perú.​', 'ligero'),
(17, 'Harina', 'La harina es el polvo fino que se obtiene del cereal molido y de otros alimentos ricos en almidón.​ Se puede obtener harina de distintos cereales. Aunque la más habitual es harina de trigo, también se hace harina de centeno, de cebada, de avena, de maíz o de arroz.', 'normal'),
(18, 'Leche entera', 'La leche es una secreción nutritiva de color blanquecino opaco producida por las células secretoras de las glándulas mamarias de los mamíferos, incluidos los monotremas.​​​​', 'normal'),
(19, 'Azúcar', 'La sacarosa o sucrosa es un disacárido formado por glucosa y fructosa. Su nombre químico es alfa-D-Glucopiranosil - - beta-D-Fructofuranósido, ​ y su fórmula es C₁₂H₂₂O₁₁. Es un disacárido que no tiene poder reductor sobre el reactivo de Fehling y el reactivo de Tollens.', 'normal'),
(20, 'Canela', 'El árbol de la canela, conocido como canelo, ​ es un árbol de hoja perenne, de 10 a 15 metros de altura, procedente de Sri Lanka. Se aprovecha como especia su corteza interna, que se obtiene pelando y frotando las ramas.', 'normal'),
(21, 'Arroz', 'El arroz es la semilla de la planta Oryza sativa o de Oryza glaberrima. Se trata de un cereal considerado alimento básico en muchas gastronomías del mundo.​ El arroz es el segundo cereal más producido en el mundo, detrás del maíz y por delante del trigo.​​', 'ligero'),
(22, 'Tomate', 'El tomate​ o jitomate​ es el fruto de la planta Solanum lycopersicum, el cual tiene importancia culinaria y es utilizado como verdura. Está considerado una hortaliza.​', 'ligero'),
(23, 'Cebolla', 'Allium cepa, comúnmente conocida como cebolla, es una planta herbácea bienal perteneciente a la familia de las amarilidáceas. Es la especie más cultivada del género Allium, el cual contiene varias especies que se denominan «cebollas» y que se cultivan como alimento.', 'ligero'),
(24, 'Caldo de verduras', 'El caldo de verduras, por ejemplo, se pueden preparar caldos muy ligeros y claros, donde uno se limita a hervir las hortalizas en abundante agua, u otros más oscuros y de sabor más intenso, como este que tenemos aquí, donde las verduras se doran previamente. Puedes añadir otros vegetales además de los incluidos en la lista e incluso hierbas o vino para aromatizar.', 'ligero'),
(25, 'Zanahoria', 'Daucus carota subespecie sativus, llamada popularmente zanahoria, es la forma domesticada de la zanahoria silvestre, especie de la familia de las umbelíferas, también denominadas apiáceas, y considerada la más importante y de mayor consumo dentro de esta familia. Es oriunda de Europa y Asia sudoccidental.', 'ligero'),
(26, 'Pimiento', 'El pimiento es una hortaliza de forma, tamaño y color variable. Puede ser verde, rojo, amarillo, naranja e incluso ¡negro!. Su sabor puede ser dulce o picante y se consume en fresco, en conserva, etc. El pimiento se consume crudo, cocido y asado; como guarnición en gran variedad de platos.', 'ligero'),
(27, 'Levadura', 'Se denomina levadura o fermento a cualquiera de los hongos microscópicos clasificados como ascomicetos o basidiomicetos, predominantemente unicelulares en su ciclo de vida.', 'normal');
...
(11, 'Sopa de tomate', 'una sopa quemagrasas que se debe de comer todos los días y en la cantidad que se desee, porque apenas tiene calorías.', '1', 2, 1, 30, 3, 1, NULL, 'sopatomate1641502211.jpg'),
(12, 'Fabada Asturiana', 'Fabada asturiana, o simplemente fabada, es el plato tradicional de la cocina asturiana elaborado con faba asturiana (en asturiano, fabes), embutidos como chorizo y la morcilla asturiana, y con cerdo. Es el plato típico de Asturias (el plato regional más conocido de la región asturiana), pero su difusión es tan grande en la península ibérica que forma parte de la gastronomía de España más reconocida. Se considera según ciertos autores una de las diez recetas típicas de la cocina española.', '1', 2, 5, 180, 5, 1, NULL, 'fabada1641502549.jpg'),
(13, 'Cachopo', 'Un cachopo qué es, pues son dos filetes de ternera uno encima del otro y en medio está relleno de jamón y queso. Luego va enharinado, pasado por huevo empanado y frito. Suena fácil, y la verdad es que es fácil hacerlo.', '2', 3, 2, 60, 5, 1, NULL, 'cachopo21641502878.jpg'),
(14, 'Arroz con leche', 'El arroz con leche es un postre típico de la gastronomía de múltiples países hecho cociendo lentamente arroz con leche y azúcar. Se sirve frío o caliente. Se le suele espolvorear canela, vainilla o cáscara de limón para aromatizarlo.', 'P', 4, 8, 140, 5, 1, NULL, 'arrozconleche1641503050.png'),
(15, 'Tortilla de patata', 'La tortilla de patatas o tortilla de papas​ o tortilla española es una tortilla u omelet ​ a la que se le agrega patatas troceadas.​ Se trata de uno de los platos más conocidos y emblemáticos de la cocina española, siendo un producto muy popular que se puede encontrar en casi cualquier bar o restaurante del país.', '1', 1, 5, 60, 5, 1, NULL, 'tortilla1641503652.jpg'),
(16, 'Pan', 'El pan, del latín panis, es un alimento básico que forma parte de la dieta tradicional en Europa, Medio Oriente, India, América y Oceanía. Se suele preparar mediante el horneado de una masa, elaborada fundamentalmente con harina de cereal, agua y sal.', 'E', 4, 5, 240, 5, 2, NULL, 'pan1641503828.jpg'),
(17, 'Huevos con patatas y jamón', 'Estos huevos revueltos o huevos estrellados con patatas, jamón y pimientos de padrón son una receta esencial y que suele gustar a todo el mundo. Creo que todos tenemos en mente la imagen de esa yema de huevo que, al romperse, comienza a escurrirse entre el resto de ingredientes, un auténtico… ¡escándalo! ', '2', 1, 1, 45, 5, 5, NULL, 'huevosjamon1641504031.jpg');
